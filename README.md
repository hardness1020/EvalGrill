...
<a href="plugin/README.md"><img src="https://img.shields.io/badge/Claude%20Code-plugin-d97757.svg" alt="Claude Code plugin"></a>
</p>
...
For the dev loop (`/reload-plugins`, validation, sandbox notes), see the [plugin README](plugin/README.md).
...
Every artifact conforms to the JSON Schemas in [`plugin/schemas/`](plugin/schemas/), and scripts are single-file PEP 723 scripts run via `uv run`: no Python environment setup.
